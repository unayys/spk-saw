...
$alternatif = array();
$q2 = mysqli_query($koneksi,"SELECT alternatif.id_alternatif, alternatif.nama, kelas.kelas 
    FROM alternatif
    JOIN kelas ON alternatif.id_kelas = kelas.id_kelas");			
while($alt = mysqli_fetch_array($q2)){
	...
	$alternatif[$alt['id_alternatif']]['kelas'] = $alt['kelas'];
} 
?>
