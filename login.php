...
<html lang="en">
    <head>
        ...
        <title>Sistem Pendukung Keputusan Siswa Berprestasi Metode SAW</title>
				...
				<div class="col-xl-6 col-lg-6 col-md-6 mt-5">
                    <div class="card bg-none o-hidden border-0 my-5 text-white" style="background: none;">
                        <div class="text-justify card-body p-0">
                            <h4 style="font-weight: 800;">Sistem Pendukung Keputusan Siswa Berprestasi Metode Simple Additive weighting</h4>
                            <p class="pt-4">
